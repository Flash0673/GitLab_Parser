...
def test_get_merge_commits_web():
    ...
    assert list(df_1.columns) == ['project_id', 'commit_id', 'commit_message', 'files_changed', 'lines_inserted', 'lines_deleted',
                                  'diff', 'target', 'changes', 'add', 'del', 'web_url',
                                  'Imports added', 'Imports deleted', 'path', 'file_new', 'file_past', 'count_py_files',
                                  'array_past', 'array_new'], "Не все колонки"
